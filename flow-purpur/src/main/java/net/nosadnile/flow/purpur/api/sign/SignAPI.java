package net.nosadnile.flow.purpur.api.sign;
...
public class SignAPI {
     ...
     * This will register a listener on your plugin so it will handle {@link net.nosadnile.flow.purpur.api.sign.PacketSign.SignClickEvent}.
     */
     ...
     * @return {@code true} (as specified by {@link java.util.Collection#remove(Object)})
     */
