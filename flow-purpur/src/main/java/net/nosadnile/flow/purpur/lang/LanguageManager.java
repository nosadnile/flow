...
import net.nosadnile.flow.purpur.api.events.PlayerLangChangeEvent;
...
public class LanguageManager implements BedWars.LanguageUtil {
    ...
    private final HashMap<Player, Language> langByPlayer = new HashMap<>();
    private final List<LanguageHelper> languages = new ArrayList<>();
    ...
    @Override
    public List<LanguageHelper> getLanguages() {
        return languages;
    }
    ...
    @Override
    public boolean addLanguage(LanguageHelper language) {
